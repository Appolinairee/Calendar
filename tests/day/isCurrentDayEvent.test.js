...
module('isCurrentDayEvent', () => {
    test("should return false when event has no startDate", assert => {
        const event = { endDate: "2024-06-25T10:30:00" };
