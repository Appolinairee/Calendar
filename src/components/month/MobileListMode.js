...
import NothingImage from "../../assets/nothing.svg";
      ...
      return m("div", { class: "list-mode-container" }, [
        m("div", { class: "list-mode" }, [
          m("div.flex.header", [
            ...
            m(
              "div",
              { class: "list-mode-date" },
              formatDate(vnode.attrs.calendar._currentDate)
            ),
          ]),
                ...
                events.map((event) =>
                  m("div", { class: "event-item" }, [
                    ...
                    m("div", [
                      ...
                      m(
                        "span",
                        formatDate(new Date(event.startDate).toLocaleString())
                      ),
                    ]),
                    m("div", [
                      ...
                      m(
                        "span",
                        formatDate(new Date(event.endDate).toLocaleString())
                      ),
                    ]),
                  ])
                )
              )
            : m("div", { style: "text-align: center; margin-top: 20px;" }, [
                m("img", {
                  src: NothingImage,
                  alt: "No events.",
